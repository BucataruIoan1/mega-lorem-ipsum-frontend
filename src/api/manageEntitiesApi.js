...
export async function fetchManagedEntities(url, fallbackError, signal) {
...
export async function createManagedEntity(url, name, fallbackError, signal) {
...
export async function updateManagedEntity(url, entityId, name, fallbackError, signal) {
  const response = await fetch(
    `${url}/${entityId}`,
    buildRequestOptions(
      'PUT',
...
export async function deleteManagedEntity(url, entityId, fallbackError, signal) {
